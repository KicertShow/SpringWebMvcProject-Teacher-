...
//	地二種方法 有回傳byte 
	@GetMapping(path = "/responseimage.controller2",produces = "text/plain;charset=UTF-8")
	@ResponseBody
	public byte[] processImgeAction2(HttpServletRequest request,HttpServletResponse response) throws IOException {
		InputStream in = request.getServletContext().getResourceAsStream("/WEB-INF/resources/images/my01.jpg");
